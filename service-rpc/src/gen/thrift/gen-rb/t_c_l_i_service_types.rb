...
module TOperationState
  ...
  PENDING_STATE = 7
  TIMEDOUT_STATE = 8
  VALUE_MAP = {0 => "INITIALIZED_STATE", 1 => "RUNNING_STATE", 2 => "FINISHED_STATE", 3 => "CANCELED_STATE", 4 => "CLOSED_STATE", 5 => "ERROR_STATE", 6 => "UNKNOWN_STATE", 7 => "PENDING_STATE", 8 => "TIMEDOUT_STATE"}
  VALID_VALUES = Set.new([INITIALIZED_STATE, RUNNING_STATE, FINISHED_STATE, CANCELED_STATE, CLOSED_STATE, ERROR_STATE, UNKNOWN_STATE, PENDING_STATE, TIMEDOUT_STATE]).freeze
end
